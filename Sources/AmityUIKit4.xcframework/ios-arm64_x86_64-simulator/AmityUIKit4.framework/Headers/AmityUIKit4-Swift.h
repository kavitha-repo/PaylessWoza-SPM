...
#ifndef AMITYUIKIT4_SWIFT_H
#define AMITYUIKIT4_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AmityUIKit4",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSURL;
SWIFT_CLASS("_TtC11AmityUIKit413AmityDocument")
...
SWIFT_CLASS("_TtC11AmityUIKit417AnimatedImageView")
...
SWIFT_CLASS("_TtC11AmityUIKit413CameraManager")
...
@interface CameraManager (SWIFT_EXTENSION(AmityUIKit4)) <AVCaptureMetadataOutputObjectsDelegate>
...
@class NSURLRequest;
@interface KFSessionDelegate (SWIFT_EXTENSION(AmityUIKit4)) <NSURLSessionDataDelegate>
...
SWIFT_CLASS("_TtC11AmityUIKit45Toast")
...
@interface UINavigationController (SWIFT_EXTENSION(AmityUIKit4)) <UIGestureRecognizerDelegate>
- (void)viewDidLoad;
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer * _Nonnull)gestureRecognizer SWIFT_WARN_UNUSED_RESULT;
- (BOOL)gestureRecognizer:(UIGestureRecognizer * _Nonnull)gestureRecognizer shouldRecognizeSimultaneouslyWithGestureRecognizer:(UIGestureRecognizer * _Nonnull)otherGestureRecognizer SWIFT_WARN_UNUSED_RESULT;
@end

SWIFT_CLASS("_TtC11AmityUIKit425VideoFullscreenPlayerView")
@interface VideoFullscreenPlayerView : UIView
- (void)layoutSubviews;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC11AmityUIKit427VideoFullscreenTransitioner")
@interface VideoFullscreenTransitioner : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@protocol UIViewControllerAnimatedTransitioning;
@interface VideoFullscreenTransitioner (SWIFT_EXTENSION(AmityUIKit4)) <UIViewControllerTransitioningDelegate>
...
@interface VideoFullscreenTransitioner (SWIFT_EXTENSION(AmityUIKit4)) <UIViewControllerAnimatedTransitioning>
...
SWIFT_CLASS("_TtC11AmityUIKit416VideoLoadManager")
...
@interface VideoLoadManager (SWIFT_EXTENSION(AmityUIKit4)) <AVAssetResourceLoaderDelegate>
...
SWIFT_CLASS("_TtC11AmityUIKit415VideoPlayerView")
...
@interface VideoPlayerView (SWIFT_EXTENSION(AmityUIKit4))
...
- (void)destroy;
- (void)playAudioTrackWithIndex:(NSInteger)index;
@end

SWIFT_CLASS("_TtC11AmityUIKit419VideoPreloadManager")
